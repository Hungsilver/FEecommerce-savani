        ...
        <div className='footer'>
            <div className='bg-black px-[10%] py-[5%]'>
                <div className='text-white flex justify-between gap-6 text-left'>
                    <div>
                        ...
                        <p>
                            <a href="#" className=''>
                                <img className='w-[120px]' src="https://savani.vn/upload_images/images/2023/02/15/bct.png" alt="" />
                            </a>
                        </p>
                    ...
                    <div>
                        ...
                        <p className=''>
                            <a href="#" className=''>
                                <img className='' src="https://savani.vn/images/zzz.svg" alt="logo" />
                            </a>
                        </p>
                    </div>
                </div>
            ...
            <div className=''>
                <div>
                    ...
                    <small>Đăng ký KD/ Mã số thuế: 2802886403 (Cấp ngày 23/10/2020)</small>
                </div>
                <div>
                    hihi
                </div>
